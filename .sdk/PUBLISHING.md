...
|---|---|---|
| `ts/` | @voxgig-sdk/wahlumfragen-datenbank-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/wahlumfragen-datenbank-sdk \
      --repository voxgig-sdk/wahlumfragen-datenbank-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/wahlumfragen-datenbank-sdk` shows it, and
`npm trust revoke @voxgig-sdk/wahlumfragen-datenbank-sdk --id=<id>` removes it.
