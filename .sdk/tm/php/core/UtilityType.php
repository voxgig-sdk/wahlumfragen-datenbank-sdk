...
// WahlumfragenDatenbank SDK utility type

class WahlumfragenDatenbankUtility
{
    ...
    public static function copy(WahlumfragenDatenbankUtility $src): WahlumfragenDatenbankUtility
    {
        $u = new WahlumfragenDatenbankUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
