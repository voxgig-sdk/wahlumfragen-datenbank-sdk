...
// WahlumfragenDatenbank SDK utility: fetcher

class WahlumfragenDatenbankFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WahlumfragenDatenbankSDK/1.0)';
    ...
    public static function call(WahlumfragenDatenbankContext $ctx, string $fullurl, array $fetchdef): array
    {
