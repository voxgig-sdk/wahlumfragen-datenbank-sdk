...
// WahlumfragenDatenbank SDK netsim feature
...
class WahlumfragenDatenbankNetsimFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    private function _simulate(WahlumfragenDatenbankContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WahlumfragenDatenbankContext $ctx, array $applied): void
    {
        $client = $this->client;
