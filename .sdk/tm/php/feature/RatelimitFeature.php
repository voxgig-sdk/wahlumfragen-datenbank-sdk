...
// WahlumfragenDatenbank SDK ratelimit feature
...
class WahlumfragenDatenbankRatelimitFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    private function _acquire(WahlumfragenDatenbankContext $ctx): void
    {
    ...
    private function _track(WahlumfragenDatenbankContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
