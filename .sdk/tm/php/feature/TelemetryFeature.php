...
// WahlumfragenDatenbank SDK telemetry feature
...
class WahlumfragenDatenbankTelemetryFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    private function _close(WahlumfragenDatenbankContext $ctx, bool $ok): void
    {
