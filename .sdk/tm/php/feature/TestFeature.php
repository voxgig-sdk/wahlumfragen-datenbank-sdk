...
// WahlumfragenDatenbank SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WahlumfragenDatenbankTestFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    public function init(WahlumfragenDatenbankContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WahlumfragenDatenbankContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = WahlumfragenDatenbankParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WahlumfragenDatenbankContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WahlumfragenDatenbankContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = WahlumfragenDatenbankParam::call($ctx, $k);
