...
// WahlumfragenDatenbank SDK pipeline test
//
...
{
    private static function utility(): WahlumfragenDatenbankUtility
    {
        return new WahlumfragenDatenbankUtility();
    }
    ...
    private static function ctx(array $over = []): WahlumfragenDatenbankContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WahlumfragenDatenbankContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WahlumfragenDatenbankOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WahlumfragenDatenbankError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WahlumfragenDatenbankOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WahlumfragenDatenbankMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WahlumfragenDatenbankOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WahlumfragenDatenbankMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WahlumfragenDatenbankOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WahlumfragenDatenbankMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WahlumfragenDatenbankSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WahlumfragenDatenbankMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WahlumfragenDatenbankResponse([]),
            'result' => new WahlumfragenDatenbankResult([]),
        ]);
        [, $err] = WahlumfragenDatenbankMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WahlumfragenDatenbankSpec([]),
            'response' => null,
            'result' => new WahlumfragenDatenbankResult([]),
        ]);
        [, $err] = WahlumfragenDatenbankMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WahlumfragenDatenbankSpec(['step' => 's']),
            'response' => new WahlumfragenDatenbankResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WahlumfragenDatenbankResult([]),
        ]);
        [, $err] = WahlumfragenDatenbankMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WahlumfragenDatenbankSpec(['step' => 's']),
            'response' => new WahlumfragenDatenbankResponse(self::resp(200, ['v' => 1])),
            'result' => new WahlumfragenDatenbankResult([]),
        ]);
        [, $err] = WahlumfragenDatenbankMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WahlumfragenDatenbankSpec(['step' => 's']),
            'response' => new WahlumfragenDatenbankResponse(self::resp(200, ['v' => 2])),
            'result' => new WahlumfragenDatenbankResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WahlumfragenDatenbankMakeResponse::call($ctx);
    ...
    {
        $preset = new WahlumfragenDatenbankResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WahlumfragenDatenbankSpec([]),
            'response' => new WahlumfragenDatenbankResponse([]),
            'result' => new WahlumfragenDatenbankResult([]),
        ...
        [$got, $err] = WahlumfragenDatenbankMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WahlumfragenDatenbankResult([])]);
        [, $err] = WahlumfragenDatenbankMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WahlumfragenDatenbankSpec([]), 'result' => null]);
        [, $err] = WahlumfragenDatenbankMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WahlumfragenDatenbankSpec(['step' => 's']),
            'result' => new WahlumfragenDatenbankResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WahlumfragenDatenbankOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WahlumfragenDatenbankMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WahlumfragenDatenbankSpec(['step' => 's']),
            'result' => new WahlumfragenDatenbankResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WahlumfragenDatenbankOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WahlumfragenDatenbankMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WahlumfragenDatenbankResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WahlumfragenDatenbankSpec([]),
            'result' => new WahlumfragenDatenbankResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WahlumfragenDatenbankMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WahlumfragenDatenbankMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WahlumfragenDatenbankError('boom', 'boom');
        $utility->fetcher = function (WahlumfragenDatenbankContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WahlumfragenDatenbankSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WahlumfragenDatenbankMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WahlumfragenDatenbankContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WahlumfragenDatenbankMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WahlumfragenDatenbankResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WahlumfragenDatenbankMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WahlumfragenDatenbankContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WahlumfragenDatenbankSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WahlumfragenDatenbankMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WahlumfragenDatenbankResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WahlumfragenDatenbankSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WahlumfragenDatenbankMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WahlumfragenDatenbankMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WahlumfragenDatenbankMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WahlumfragenDatenbankResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WahlumfragenDatenbankDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WahlumfragenDatenbankResult(['ok' => false])]);
        $this->expectException(WahlumfragenDatenbankError::class);
        WahlumfragenDatenbankDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WahlumfragenDatenbankResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WahlumfragenDatenbankMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WahlumfragenDatenbankMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WahlumfragenDatenbankBaseFeature();
        $b = new WahlumfragenDatenbankBaseFeature();
        WahlumfragenDatenbankFeatureAdd::call($ctx, $a);
        WahlumfragenDatenbankFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WahlumfragenDatenbankBaseFeature
    {
        $f = new WahlumfragenDatenbankBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WahlumfragenDatenbankFeatureAdd::call($ctx, self::named_feature('a'));
        WahlumfragenDatenbankFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        WahlumfragenDatenbankFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        WahlumfragenDatenbankFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        WahlumfragenDatenbankFeatureAdd::call($ctx, $replace);
        ...
        WahlumfragenDatenbankFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WahlumfragenDatenbankContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WahlumfragenDatenbankSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WahlumfragenDatenbankPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WahlumfragenDatenbankPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WahlumfragenDatenbankResponse(['headers' => null]),
            'result' => new WahlumfragenDatenbankResult([]),
        ]);
        WahlumfragenDatenbankResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WahlumfragenDatenbankResultBody::call($ctx);
