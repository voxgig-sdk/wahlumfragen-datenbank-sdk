...
from projectname_sdk.core.control import WahlumfragenDatenbankControl
...
class WahlumfragenDatenbankContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WahlumfragenDatenbankControl()
        ...
        if isinstance(sp, WahlumfragenDatenbankSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WahlumfragenDatenbankResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WahlumfragenDatenbankResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WahlumfragenDatenbankOperation({})
    ...
    def make_error(self, code, msg):
        return WahlumfragenDatenbankError(code, msg, self)
