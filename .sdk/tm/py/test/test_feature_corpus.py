# WahlumfragenDatenbank SDK feature corpus test
#
...
def _client(kase):
    ...
    WahlumfragenDatenbankSDK(...), not WahlumfragenDatenbankSDK.test(...): the `test` feature is
    ...
    return WahlumfragenDatenbankSDK(opts)
