...
describe("GetPollingDatabaseDirect", function()
  it("should direct-list-get_polling_database", function()
    local setup = get_polling_database_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_polling_database", setup.live and "live" or "unit")
...
function get_polling_database_direct_setup(mockres)
