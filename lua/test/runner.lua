...
function runner.env_override(m)
  local live = runner.getenv("WAHLUMFRAGEN_DATENBANK_TEST_LIVE")
  local override = runner.getenv("WAHLUMFRAGEN_DATENBANK_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WAHLUMFRAGEN_DATENBANK_TEST_EXPLAIN")
