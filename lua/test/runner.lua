...
function runner.env_override(m)
  local live = runner.getenv("WAHLUMFRAGENDATENBANK_TEST_LIVE")
  local override = runner.getenv("WAHLUMFRAGENDATENBANK_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WAHLUMFRAGENDATENBANK_TEST_EXPLAIN")
