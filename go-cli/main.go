// Command WahlumfragenDatenbank-cli is a CLI + REPL for the WahlumfragenDatenbank SDK,
...
const prompt = "wahlumfragen-datenbank"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "get_polling_database metadata"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      WAHLUMFRAGEN_DATENBANK_APIKEY (api key), WAHLUMFRAGEN_DATENBANK_BASE (base url override)")
