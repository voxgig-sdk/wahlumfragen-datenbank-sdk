...
AQL-driven command-line client **and** interactive REPL for the WahlumfragenDatenbank
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `get_polling_database`).
