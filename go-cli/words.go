...
func registerSDKWords(r *eng.Registry, client *sdk.WahlumfragenDatenbankSDK) {
...
func runOp(client *sdk.WahlumfragenDatenbankSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
