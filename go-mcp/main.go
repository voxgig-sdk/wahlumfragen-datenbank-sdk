// Command WahlumfragenDatenbank-mcp is an MCP server exposing the WahlumfragenDatenbank
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WahlumfragenDatenbank_list  — list records of an entity
//	WahlumfragenDatenbank_load  — load a single record of an entity
//
