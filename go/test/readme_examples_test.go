...
const testSeed = `map[string]any{"entity": map[string]any{"get_polling_database": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metadata": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
