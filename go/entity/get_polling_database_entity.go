...
type GetPollingDatabaseEntity struct {
	name    string
	client  *core.WahlumfragenDatenbankSDK
...
func NewGetPollingDatabaseEntity(client *core.WahlumfragenDatenbankSDK, entopts map[string]any) *GetPollingDatabaseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetPollingDatabaseEntity) GetName() string { return e.name }
...
func (e *GetPollingDatabaseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetPollingDatabaseEntity) Deleted() bool {
	return e.deleted
}


func (e *GetPollingDatabaseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetPollingDatabaseEntity(e.client, opts)
}

func (e *GetPollingDatabaseEntity) Data(args ...any) any {
...
func (e *GetPollingDatabaseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetPollingDatabaseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetPollingDatabaseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *GetPollingDatabaseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetPollingDatabaseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetPollingDatabaseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetPollingDatabaseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
