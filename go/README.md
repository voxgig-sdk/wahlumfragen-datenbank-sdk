# WahlumfragenDatenbank Golang SDK
...
## Install
```bash
go get github.com/voxgig-sdk/wahlumfragen-datenbank-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/wahlumfragen-datenbank-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/wahlumfragen-datenbank-sdk/go=../wahlumfragen-datenbank-sdk/go
```
...
```go
    result, err := client.GetPollingDatabase(nil).List(nil, nil)
    if err != nil {
        panic(err)
    }
...
| `GetPollingDatabase` | `(data map[string]any) WahlumfragenDatenbankEntity` | Create a GetPollingDatabase entity instance. |
| `Metadata` | `(data map[string]any) WahlumfragenDatenbankEntity` | Create a Metadata entity instance. |

### Entity interface (WahlumfragenDatenbankEntity)

All entities implement the `WahlumfragenDatenbankEntity` interface.
