...
type WahlumfragenDatenbankSDK struct {
	Mode     string
...
func NewWahlumfragenDatenbankSDK(options map[string]any) *WahlumfragenDatenbankSDK {
	sdk := &WahlumfragenDatenbankSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *WahlumfragenDatenbankSDK) OptionsMap() map[string]any {
...
func (sdk *WahlumfragenDatenbankSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WahlumfragenDatenbankSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WahlumfragenDatenbankSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WahlumfragenDatenbankSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WahlumfragenDatenbankSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WahlumfragenDatenbankSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WahlumfragenDatenbankSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WahlumfragenDatenbankSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WahlumfragenDatenbankSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WahlumfragenDatenbankSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *WahlumfragenDatenbankSDK {
	if sdkopts == nil {
	...
	sdk := NewWahlumfragenDatenbankSDK(sdkopts)
	sdk.Mode = "test"
