...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.WAHLUMFRAGENDATENBANK_TEST_LIVE ||
    'TRUE' === process.env.WAHLUMFRAGENDATENBANK_TEST_OVERRIDE
  ) {
  ...
  m.WAHLUMFRAGENDATENBANK_TEST_EXPLAIN = process.env.WAHLUMFRAGENDATENBANK_TEST_EXPLAIN || m.WAHLUMFRAGENDATENBANK_TEST_EXPLAIN
