...
function envOverride(m) {
    if ('TRUE' === process.env.WAHLUMFRAGEN_DATENBANK_TEST_LIVE ||
        'TRUE' === process.env.WAHLUMFRAGEN_DATENBANK_TEST_OVERRIDE) {
    ...
    m.WAHLUMFRAGEN_DATENBANK_TEST_EXPLAIN = process.env.WAHLUMFRAGEN_DATENBANK_TEST_EXPLAIN || m.WAHLUMFRAGEN_DATENBANK_TEST_EXPLAIN;
    return m;
}
