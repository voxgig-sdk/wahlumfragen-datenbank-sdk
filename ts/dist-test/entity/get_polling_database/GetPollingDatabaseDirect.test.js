...
(0, node_test_1.describe)('GetPollingDatabaseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WahlumfragenDatenbankSDK({
    ...
    (0, node_test_1.test)('direct-list-get_polling_database', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_polling_database', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.WAHLUMFRAGEN_DATENBANK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WahlumfragenDatenbankSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['WAHLUMFRAGEN_DATENBANK_TEST_GET_POLLING_DATABASE_ENTID'];
    ...
    const client = new __1.WahlumfragenDatenbankSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetPollingDatabaseDirect.test.js.map