# WahlumfragenDatenbank TypeScript SDK Reference

Complete API reference for the WahlumfragenDatenbank TypeScript SDK.
...
```ts
new WahlumfragenDatenbankSDK(options?: object)
```
...
#### `WahlumfragenDatenbankSDK.test(testopts?, sdkopts?)`
...
**Returns:** `WahlumfragenDatenbankSDK` instance in test mode.


### Instance Methods

#### `GetPollingDatabase(data?: object)`

Create a new `GetPollingDatabase` entity instance.
...
**Returns:** `GetPollingDatabaseEntity` instance.
...
Alias for `WahlumfragenDatenbankSDK.test()`.
...
Return the parent `WahlumfragenDatenbankSDK` instance.
