...
class WahlumfragenDatenbankTestRunner
{
    ...
    {
        $live = self::getenv('WAHLUMFRAGENDATENBANK_TEST_LIVE');
        $override = self::getenv('WAHLUMFRAGENDATENBANK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('WAHLUMFRAGENDATENBANK_TEST_EXPLAIN');
