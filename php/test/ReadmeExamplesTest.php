...
// WahlumfragenDatenbank SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WahlumfragenDatenbankSDK::test)
...
{
    private const SDK_CLASS = 'WahlumfragenDatenbankSDK';
    ...
    private const SDK_BASE = 'wahlumfragendatenbank_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../wahlumfragendatenbank_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
