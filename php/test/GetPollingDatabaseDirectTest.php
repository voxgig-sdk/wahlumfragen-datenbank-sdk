...
class GetPollingDatabaseDirectTest extends TestCase
{
    public function test_direct_list_get_polling_database(): void
    {
        $setup = get_polling_database_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-get_polling_database", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
