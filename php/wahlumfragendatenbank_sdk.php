...
class WahlumfragenDatenbankSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = WahlumfragenDatenbankHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = WahlumfragenDatenbankHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!WahlumfragenDatenbankFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, WahlumfragenDatenbankFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return WahlumfragenDatenbankUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = WahlumfragenDatenbankHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = WahlumfragenDatenbankHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = WahlumfragenDatenbankHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new WahlumfragenDatenbankError($op . "_allow",
                "WahlumfragenDatenbankSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = WahlumfragenDatenbankHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new WahlumfragenDatenbankError("graphql_error",
                "WahlumfragenDatenbankSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetPollingDatabase($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_polling_database === null) {
                $this->_get_polling_database = new GetPollingDatabaseEntity($this, null);
            }
            return $this->_get_polling_database;
        }
        return new GetPollingDatabaseEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new WahlumfragenDatenbankSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
