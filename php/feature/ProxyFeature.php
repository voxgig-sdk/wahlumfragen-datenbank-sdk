...
// WahlumfragenDatenbank SDK proxy feature
...
class WahlumfragenDatenbankProxyFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    public function init(WahlumfragenDatenbankContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WahlumfragenDatenbankContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
