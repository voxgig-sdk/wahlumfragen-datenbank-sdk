...
// WahlumfragenDatenbank SDK streaming feature
...
class WahlumfragenDatenbankStreamingFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    private function _iterate(WahlumfragenDatenbankResult $result): \Generator
    {
    ...
    private function _streamable(WahlumfragenDatenbankContext $ctx): bool
    {
