...
// WahlumfragenDatenbank SDK clienttrack feature
...
class WahlumfragenDatenbankClienttrackFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    public function PostConstruct(WahlumfragenDatenbankContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WahlumfragenDatenbank-SDK';
