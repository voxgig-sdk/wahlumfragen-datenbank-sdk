...
// WahlumfragenDatenbank SDK timeout feature
...
class WahlumfragenDatenbankTimeoutFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    private function _with_timeout(WahlumfragenDatenbankContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WahlumfragenDatenbankContext $_ctx, float $ms): void
    {
        $client = $this->client;
