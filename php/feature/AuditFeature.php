...
// WahlumfragenDatenbank SDK audit feature
...
class WahlumfragenDatenbankAuditFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    private function _emit(WahlumfragenDatenbankContext $ctx, string $outcome): void
    {
