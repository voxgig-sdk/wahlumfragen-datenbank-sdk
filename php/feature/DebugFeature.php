...
// WahlumfragenDatenbank SDK debug feature
...
class WahlumfragenDatenbankDebugFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    private function _finish(WahlumfragenDatenbankContext $ctx, bool $ok): void
    {
