...
// WahlumfragenDatenbank SDK cache feature
...
class WahlumfragenDatenbankCacheFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    private function _through(WahlumfragenDatenbankContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
