...
// WahlumfragenDatenbank SDK rbac feature
...
class WahlumfragenDatenbankRbacFeature extends WahlumfragenDatenbankBaseFeature
{
    ...
    private function _required(WahlumfragenDatenbankContext $ctx): ?string
    {
    ...
    private function _reject(WahlumfragenDatenbankContext $ctx, string $required): void
    {
    ...
    private function _track(WahlumfragenDatenbankContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
