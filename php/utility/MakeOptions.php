...
// WahlumfragenDatenbank SDK utility: make_options

class WahlumfragenDatenbankMakeOptions
{
    ...
    public static function call(WahlumfragenDatenbankContext $ctx): array
    {
        ...
        //
        // `WahlumfragenDatenbankSchema::optspec()` is built from the model:
        ...
        $optspec = WahlumfragenDatenbankSchema::optspec();
