...
// WahlumfragenDatenbank SDK utility: graphql
//
...
class WahlumfragenDatenbankGraphql
{
    ...
    // equivalent.
    public static function body(WahlumfragenDatenbankContext $ctx): mixed
    {
    ...
    public static function errors(WahlumfragenDatenbankContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
