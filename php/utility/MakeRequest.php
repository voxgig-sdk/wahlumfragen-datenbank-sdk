...
// WahlumfragenDatenbank SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WahlumfragenDatenbankMakeRequest
{
    public static function call(WahlumfragenDatenbankContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WahlumfragenDatenbankResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WahlumfragenDatenbankResponse($fetched);
        } else {
