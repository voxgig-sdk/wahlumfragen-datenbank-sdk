...
#      offline in seeded test mode (WahlumfragenDatenbankSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WahlumfragenDatenbank_sdk.rb")
  SDK_CLASS = "WahlumfragenDatenbankSDK"
  ...
  SDK_BASE = "WahlumfragenDatenbank_sdk"
