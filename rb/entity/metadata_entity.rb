# WahlumfragenDatenbank SDK Metadata entity
...
class MetadataEntity
  ...
  # @return [Metadata, Hash] the loaded Metadata; raises WahlumfragenDatenbankError on failure
    ...
    _run_op(ctx) do
      if ctx.result
        ...
        if ctx.result.resdata
          @_data = WahlumfragenDatenbankHelpers.to_map(VoxgigStruct.clone(ctx.result.resdata)) || {}
        end
      end
    end
  end
