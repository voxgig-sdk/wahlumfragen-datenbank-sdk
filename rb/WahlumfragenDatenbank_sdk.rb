...
require_relative 'WahlumfragenDatenbank_types'
...
class WahlumfragenDatenbankSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = WahlumfragenDatenbankHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = WahlumfragenDatenbankHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, WahlumfragenDatenbankFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    WahlumfragenDatenbankUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = WahlumfragenDatenbankHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = WahlumfragenDatenbankHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = WahlumfragenDatenbankHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => WahlumfragenDatenbankError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue WahlumfragenDatenbankError => err
    ...
    if fetched.is_a?(Hash)
      status = WahlumfragenDatenbankHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = WahlumfragenDatenbankError.new(
        "graphql_error", "WahlumfragenDatenbankSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = WahlumfragenDatenbankSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
