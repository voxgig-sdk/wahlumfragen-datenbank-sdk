...
Results: Successful response containing the complete polling database.
...
Results: Successful response containing the last update timestamp.
...
| --- | --- | --- | --- |
| GetPollingDatabase | `list` | `GET /` | See reference |
| Metadata | `load` | `GET /last_update.txt` | See reference |

## Connect to the API

- Production server: `https://api.dawum.de`
...
- `wahlumfragen-datenbank_list`: List records for an entity. Supported entities: `get_polling_database`.
- `wahlumfragen-datenbank_load`: Load one record for an entity. Supported entities: `metadata`.
