...
from wahlumfragendatenbank_sdk.wahlumfragendatenbank_types import (
    GetPollingDatabase,
    GetPollingDatabaseListMatch,
)
...
class GetPollingDatabaseEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetPollingDatabaseEntity(self._client, opts)
    ...
    def data_get(self) -> GetPollingDatabase:
    ...
    def match_get(self) -> GetPollingDatabase:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetPollingDatabase]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetPollingDatabase().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
