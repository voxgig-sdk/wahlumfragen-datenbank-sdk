...
from wahlumfragendatenbank_sdk.utility import register

# Load features
from wahlumfragendatenbank_sdk.feature.base_feature import WahlumfragenDatenbankBaseFeature
from wahlumfragendatenbank_sdk.features import _has_feature, _make_feature
...
class WahlumfragenDatenbankSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = WahlumfragenDatenbankUtility()
    ...
    def get_utility(self):
        return WahlumfragenDatenbankUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WahlumfragenDatenbankSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetPollingDatabase(self, data=None) -> "GetPollingDatabaseEntity":
        ...
        from wahlumfragendatenbank_sdk.entity.get_polling_database_entity import GetPollingDatabaseEntity
    ...
    def Metadata(self, data=None) -> "MetadataEntity":
        ...
        from wahlumfragendatenbank_sdk.entity.metadata_entity import MetadataEntity
