# WahlumfragenDatenbank SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WahlumfragenDatenbankSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WahlumfragenDatenbankSDK(...) and WahlumfragenDatenbankSDK.test(...) become
#      WahlumfragenDatenbankSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "wahlumfragendatenbank_sdk"
_SDK_CLASS = "WahlumfragenDatenbankSDK"
...
_ENTITIES = {
    "GetPollingDatabase": "get_polling_database",
    "Metadata": "metadata",
}
